...
import { useNavigate, Link } from "react-router-dom"; // <--- USE REAL ROUTER IMPORTS
import {
  LogIn,
  Mail,
  Lock,
...
// Remove redefinition of useNavigate (already imported from 'react-router-dom'), so nothing here.

// Mock Link component for internal navigation without react-router-dom
// Remove the mock Link component as the real one is now imported from 'react-router-dom'
...
const socialIcons = [
  {
    Icon: "M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c1 1.6 3 2 5 2 6 0 11-5 11-11v-.5c.67-.36 1.25-.85 1.76-1.42z",
    name: "X (Twitter)",
  },
  {
  ...
  {
    Icon: "M18 2h-3.922c-1.465 0-2.845.568-3.882 1.584C9.178 4.606 8.65 5.986 8.65 7.452v2.548H6.65v4h2v7h4v-7h2.898l.602-4h-3.5v-2.548c0-.623.238-1.218.66-1.427 1.407-1.427 4.09-1.427 5.503 0l.004-.002V8z",
    name: "Instagram",
  },
];
...
const googleIconPath = (
  <>
    <path
      fill="#FFC107"
      d="M43.611 20.083H42V20h-20v8h11.979c-1.045 3.037-2.94 4.887-5.918 5.828l.192 1.342a12.875 12.875 0 007.828-2.618c2.146-1.789 3.547-4.387 4.092-7.235z"
    />
    <path
      fill="#4CAF50"
      d="M22 41V33.28h-3.322l-.192 1.342c1.782 1.054 3.794 1.708 5.922 1.708 2.073 0 3.968-.62 5.578-1.71l-1.428-1.096A8.09 8.09 0 0122 36c-2.736 0-5.11-1.353-6.622-3.418L14 34.02v3.98H22z"
    />
    <path
      fill="#4285F4"
      d="M4.091 28.083v-8.166H2V20h2.091a11.968 11.968 0 00.322 8.083H4V28z"
    />
    <path
      fill="#F44336"
      d="M22 12c-2.457 0-4.743.896-6.527 2.404L14 13.98v-3.98h-.022A12.001 12.001 0 0022 8c2.457 0 4.743.896 6.527 2.404L29 9.976V13.98h.022c-1.784-1.508-4.07-2.404-6.527-2.404z"
    />
  </>
);
    ...
    <div
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          style={{ color: themeColors.BASE_BG }}>
          <X className="w-5 h-5" />
        </button>
      </div>
...
const Header = () => {
  ...
  return (
    <header
      className="fixed top-0 left-0 w-full z-50 p-4 md:px-12 backdrop-blur-xl border-b shadow-lg"
      style={{
        backgroundColor: `${themeColors.BASE_BG}E6`,
      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        <h1
          ...
          <Link to="/">
            <span style={{ color: themeColors.PRIMARY_COLOR }}>Adrenaline</span>{" "}
            ADS
          </Link>
        </h1>
        ...
        <div className="hidden md:flex space-x-4 items-center">
          ...
          <div className="relative group">
            ...
            {/* Dropdown Content */}
            <div
              className="absolute right-0 top-full mt-2 w-40 rounded-lg shadow-xl opacity-0 invisible group-hover:visible group-hover:opacity-100 transition-all duration-300 transform scale-95 group-hover:scale-100 origin-top-right z-50 overflow-hidden"
              style={{
                backgroundColor: themeColors.SECONDARY_COLOR,
                border: `1px solid ${themeColors.MID_TEXT}33`,
              }}>
              {navItems.map((item) => (
                <a
                  key={item.name}
                  ...
                  style={{
                    ...
                    borderBottom:
                      item.name !== "Contact Us"
                        ? `1px solid ${themeColors.MID_TEXT}1A`
                        : "none",
                  }}>
                  {item.name}
                </a>
      ...
      {isOpen && (
        <div
          className="md:hidden mt-4 space-y-3 p-4 rounded-xl shadow-xl"
          style={{
            backgroundColor: themeColors.SECONDARY_COLOR,
            border: `1px solid ${themeColors.MID_TEXT}33`,
          }}>
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <h1
              ...
              <a href="#home" style={{ textDecoration: "none" }}>
                <span style={{ color: themeColors.PRIMARY_COLOR }}>
                  Adrenaline
                </span>{" "}
                ADS
              </a>
            ...
            <p
              ...
              style={{ color: themeColors.MID_TEXT }}>
              The next generation platform for instant outdoor advertising
              management.
            </p>
          </div>
          ...
          {mockLinks.map((col, index) => (
            <div key={index}>
              <h4
                className="font-semibold mb-4 border-b w-min whitespace-nowrap"
                style={{
                  color: themeColors.DARK_TEXT,
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li style={{ color: themeColors.MID_TEXT }}>
                Email:{" "}
                <a
                  href="mailto:contact@ams.com"
                  style={{ color: themeColors.DARK_TEXT }}>
                  contact@ams.com
                </a>
              </li>
        ...
        <div
          ...
          style={{ borderColor: `${themeColors.MID_TEXT}33` }}>
          <p className="text-sm" style={{ color: themeColors.MID_TEXT }}>
            &copy; {new Date().getFullYear()} Adrenaline ADS. All rights
            reserved.
          </p>
        </div>
      </div>
...
const ForgotPasswordForm = ({ onBack }) => {
  ...
  const primaryButtonTextColor =
    themeColors.BASE_BG === THEME_CONFIG.dark.BASE_BG ? "#111111" : "#FFFFFF";
  ...
  return (
    <div className="space-y-8 p-4">
      ...
      <p className="text-center" style={{ color: themeColors.MID_TEXT }}>
        Enter your registered email to receive a password reset link.
      </p>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="relative">
          <label htmlFor="recoveryEmail" className="sr-only">
            Email Address
          </label>
          <Mail
        ...
        <button
          type="submit"
          className="w-full flex items-center justify-center space-x-2 px-4 py-3 text-lg font-bold rounded-lg transition hover:opacity-90"
          style={{
        ...
        {message && (
          <p
            ...
            style={{ color: themeColors.SUCCESS_COLOR }}>
            {message}
          </p>
        )}
...
const AuthPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!isLogin) {
      if (password !== confirmPassword) {
        setError(
          "Password mismatch. Please ensure both password fields match."
        );
        return;
      }
    ...
    console.log("--- SUBMISSION SUCCESSFUL ---", userData);
    setError(
      `Successfully submitted ${userData.mode} form (Role ID: ${userData.role_id}). Mock redirecting...`
    );
  ...
  const cardStyle = {
    ...
    boxShadow: `0 10px 30px ${
      themeMode === "dark" ? "rgba(0,0,0,0.5)" : "rgba(0,0,0,0.1)"
    }`,
  };
  ...
  return (
    <div className="min-h-screen flex flex-col" style={pageStyle}>
      ...
      <main className="flex-grow flex flex-col items-center justify-center w-full p-4 pt-20 md:pt-24">
        {!isForgotPassword && (
          <div className="w-full max-w-lg mb-2 text-right">
            <a
              ...
              className="text-sm font-medium transition duration-200 flex items-center justify-end hover:opacity-80"
              style={{ color: themeColors.MID_TEXT }}>
              {isAdminLoginMode
        ...
        <div
          className="w-full max-w-lg rounded-xl transition-all duration-500"
          style={cardStyle}>
          {isForgotPassword ? (
            ...
            <div className="p-8 md:p-12">
              ...
              <p
                ...
                {isLogin
                  ? isAdminLoginMode
                    ...
                    : "Access your Advertisement Management System."
                  : "Sign up to manage your campaigns efficiently."}
              </p>

              <div
                className="flex justify-center mb-10 rounded-lg overflow-hidden border border-white/10"
                style={{ borderColor: themeColors.PRIMARY_COLOR }}>
                <button
                  onClick={() => {
                    setIsLogin(true);
                    setRoleId(ROLE_CUSTOMER);
                    setError(null);
                  }}
                  className={`flex-1 py-3 text-sm font-semibold transition duration-300 ${
                    isLogin ? "" : "hover:opacity-80"
                  }`}
                  style={
                    isLogin
                      ? {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center space-x-2 px-4 py-3 text-lg font-bold rounded-lg mt-8 transition hover:opacity-90"
                  style={{
                    backgroundColor: themeColors.PRIMARY_COLOR,
                    color: primaryButtonTextColor,
        ...
        {!isForgotPassword && (
          <button
            className="w-full max-w-lg mt-6 flex items-center justify-center space-x-3 px-4 py-3 text-base font-semibold rounded-full border transition hover:opacity-80"
            style={{
              backgroundColor: themeColors.SECONDARY_COLOR,
              color: themeColors.DARK_TEXT,
              borderColor: themeColors.MID_TEXT + "33",
